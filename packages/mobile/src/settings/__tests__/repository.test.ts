      ...
      runAsync: jest.fn(async (sql: string, params: unknown[]) => {
        if (sql.includes("UPDATE app_settings")) {
          ...
          this.row = {
            ...
            show_performer_labels: params[16],
            show_performer_names: params[17],
            show_prop_labels: params[18],
            show_prop_names: params[19],
            show_transition_markers: params[20],
            show_all_transition_sets: params[21],
            previous_transition_set_count: params[22],
            next_transition_set_count: params[23],
            distance_green_threshold_steps: params[24],
            distance_yellow_threshold_steps: params[25],
            motion_interpolation_enabled: params[26],
            mock_live_position_enabled: params[27],
            mock_live_position_x_steps: params[28],
            mock_live_position_y_steps: params[29],
            comfortable_anchor_range_meters: params[30],
            active_drill_id: params[31],
            selected_drill_page_id: params[32],
          };
        }
