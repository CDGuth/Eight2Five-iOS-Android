[kkmhogen](/kkmhogen) / **[KBeaconProDemo\_Ios](/kkmhogen/KBeaconProDemo_Ios)** Public

*   [Notifications](/login?return_to=%2Fkkmhogen%2FKBeaconProDemo_Ios) You must be signed in to change notification settings
*   [Fork 4](/login?return_to=%2Fkkmhogen%2FKBeaconProDemo_Ios)
*   [Star 7](/login?return_to=%2Fkkmhogen%2FKBeaconProDemo_Ios)
    

### License

[MIT license](/kkmhogen/KBeaconProDemo_Ios/blob/main/LICENSE)

[7 stars](/kkmhogen/KBeaconProDemo_Ios/stargazers) [4 forks](/kkmhogen/KBeaconProDemo_Ios/forks) [Branches](/kkmhogen/KBeaconProDemo_Ios/branches) [Tags](/kkmhogen/KBeaconProDemo_Ios/tags) [Activity](/kkmhogen/KBeaconProDemo_Ios/activity)

[Star](/login?return_to=%2Fkkmhogen%2FKBeaconProDemo_Ios)

[Notifications](/login?return_to=%2Fkkmhogen%2FKBeaconProDemo_Ios) You must be signed in to change notification settings

# kkmhogen/KBeaconProDemo\_Ios

  main

[Branches](/kkmhogen/KBeaconProDemo_Ios/branches)[Tags](/kkmhogen/KBeaconProDemo_Ios/tags)

[](/kkmhogen/KBeaconProDemo_Ios/branches)[](/kkmhogen/KBeaconProDemo_Ios/tags)
...
[33 Commits](/kkmhogen/KBeaconProDemo_Ios/commits/main/)

[](/kkmhogen/KBeaconProDemo_Ios/commits/main/)

[KBeaconProDemo.xcodeproj](/kkmhogen/KBeaconProDemo_Ios/tree/main/KBeaconProDemo.xcodeproj "KBeaconProDemo.xcodeproj")

[KBeaconProDemo.xcodeproj](/kkmhogen/KBeaconProDemo_Ios/tree/main/KBeaconProDemo.xcodeproj "KBeaconProDemo.xcodeproj")

[KBeaconProDemo.xcworkspace](/kkmhogen/KBeaconProDemo_Ios/tree/main/KBeaconProDemo.xcworkspace "KBeaconProDemo.xcworkspace")

[KBeaconProDemo.xcworkspace](/kkmhogen/KBeaconProDemo_Ios/tree/main/KBeaconProDemo.xcworkspace "KBeaconProDemo.xcworkspace")

[KBeaconProDemo](/kkmhogen/KBeaconProDemo_Ios/tree/main/KBeaconProDemo "KBeaconProDemo")

[KBeaconProDemo](/kkmhogen/KBeaconProDemo_Ios/tree/main/KBeaconProDemo "KBeaconProDemo")

[Pods](/kkmhogen/KBeaconProDemo_Ios/tree/main/Pods "Pods")

[Pods](/kkmhogen/KBeaconProDemo_Ios/tree/main/Pods "Pods")

[.DS\_Store](/kkmhogen/KBeaconProDemo_Ios/blob/main/.DS_Store ".DS_Store")

[.DS\_Store](/kkmhogen/KBeaconProDemo_Ios/blob/main/.DS_Store ".DS_Store")

[FileDownloader.swift](/kkmhogen/KBeaconProDemo_Ios/blob/main/FileDownloader.swift "FileDownloader.swift")

[FileDownloader.swift](/kkmhogen/KBeaconProDemo_Ios/blob/main/FileDownloader.swift "FileDownloader.swift")

[LICENSE](/kkmhogen/KBeaconProDemo_Ios/blob/main/LICENSE "LICENSE")

[LICENSE](/kkmhogen/KBeaconProDemo_Ios/blob/main/LICENSE "LICENSE")

[Podfile](/kkmhogen/KBeaconProDemo_Ios/blob/main/Podfile "Podfile")

[Podfile](/kkmhogen/KBeaconProDemo_Ios/blob/main/Podfile "Podfile")

[Podfile.lock](/kkmhogen/KBeaconProDemo_Ios/blob/main/Podfile.lock "Podfile.lock")

[Podfile.lock](/kkmhogen/KBeaconProDemo_Ios/blob/main/Podfile.lock "Podfile.lock")

[README.md](/kkmhogen/KBeaconProDemo_Ios/blob/main/README.md "README.md")

[README.md](/kkmhogen/KBeaconProDemo_Ios/blob/main/README.md "README.md")

[kbeacon\_dfu\_\_ios\_arc.png](/kkmhogen/KBeaconProDemo_Ios/blob/main/kbeacon_dfu__ios_arc.png "kbeacon_dfu__ios_arc.png")

[kbeacon\_dfu\_\_ios\_arc.png](/kkmhogen/KBeaconProDemo_Ios/blob/main/kbeacon_dfu__ios_arc.png "kbeacon_dfu__ios_arc.png")

[tilt\_angle.png](/kkmhogen/KBeaconProDemo_Ios/blob/main/tilt_angle.png "tilt_angle.png")
...
*   KBeaconProDemo\_Ios: The app can scan KBeacon devices and configure iBeacon related parameters.
...
kbeaconlib2 is available through [CocoaPods](https://cocoapods.org). To install it, simply add the following line to your Podfile:
...
3.  Start scanning  
  ...
  if (scanResult)
  {
      ...
      self.mScanButton.title \= NSLocalizedString("ACTION\_STOP\_SCAN", comment:"")
  }
  else
  {
    ...
    for advPacket in allAdvPackets
    {
        ...
        case KBAdvType.Sensor:
            if let sensorAdv \= advPacket as? KBAdvPacketSensor
            {
                ...
                if (sensorAdv.batteryLevel != KBCfgBase.INVALID\_UINT16)
                {
                    print("batt:\\(sensorAdv.batteryLevel)")
                }

                //check if has temperature
                if (sensorAdv.temperature != KBCfgBase.INVALID\_FLOAT)
                {
                    print("temp:\\(sensorAdv.temperature)")
                }

                //check if has humidity
                if (sensorAdv.humidity != KBCfgBase.INVALID\_FLOAT)
                {
                ...
                if (KBCfgBase.INVALID\_UINT8 != sensorAdv.pirIndication)
                {
                    print("PIR indication:\\(sensorAdv.pirIndication)")
                }

                //check if has light level
                if (KBCfgBase.INVALID\_UINT16 != sensorAdv.luxLevel)
                {
...
func updateCommPara()
{
    ...
    if (txtName.tag \== DeviceViewController.TXT\_DATA\_MODIFIED),
...
func updateIBeaconPara()
{
    ...
    if let strAdvPeriod \= txtAdvPeriod.text,
       ...
       (fAdvPeriod <= KBCfgAdvIBeacon.MAX\_ADV\_PERIOD && fAdvPeriod \>= KBCfgAdvIBeacon.MIN\_ADV\_PERIOD )
    {
...
func updateKBeaconToIBeaconTLM\_unconnectable()
{
    if (self.beacon!.state != KBConnState.Connected)
    {
    ...
    iBeaconAdv.setTxPower(KBAdvTxPower.RADIO\_Neg12dBm)   //only used for nearby application
    ...
    eddyTLMAdv.setTxPower(KBAdvTxPower.RADIO\_0dBm)
...
func updateKBeaconToEddyURL()
{
    ...
    eddyURLAdv.setTxPower(KBAdvTxPower.RADIO\_Neg20dBm)   //only for nearby (3~4 meters)
...
if commCfg.isSupportEBeacon()
    ...
    encKSensorAdv.setAesType(Int(KBCfgAdvEBeacon.AES\_ECB\_TYPE))
    ...
...
func enableBtnTriggerEvtToSlot1Advertisement()
{
    ...
    slot0DefaultAdv.setTxPower(KBAdvTxPower.RADIO\_0dBm)
    ...
    btnTriggerPara.setTriggerAdvTxPower(KBAdvTxPower.RADIO\_Neg4dBm)
...
@IBAction func onEnableMotionTrigger(\_ sender: Any)
{
    ...
    accTriggerPara.setTriggerAdvTxPower(KBAdvTxPower.RADIO\_Neg4dBm)

    //add acc motion para
    accTriggerPara.setTriggerPara(5)    //motion sensitivity, unit is 16mg
    accTriggerPara.setAccODR(KBCfgTriggerMotion.ACC\_ODR\_25\_HZ)
...
@IBAction func onTHTrigger2Adv(\_ sender: Any)
{
    ...
    slot1TriggerAdv.setTxPower(KBAdvTxPower.RADIO\_0dBm)
...
[](#4351-config-temperature-and-humidity-sensor-parameters)
...
[](#4352-config-light-sensor-parameters)
...
[](#4353-config-sleep-period-parameters)
...
[](#4354-config-parking-sensor-paramaters)
...
[](#4355-config-repeater-scanning-sensor)
...
[](#4362-read-sensor-events-records)
...
func readTempHistoryRecordExample()
{
    self.beacon!.readSensorRecord(KBSensorType.HTHumidity,
                                  number: KBRecordDataRsp.INVALID\_DATA\_RECORD\_POS,
...
var mNextReadReverseIndex \= KBRecordDataRsp.INVALID\_DATA\_RECORD\_POS;
...
*   DFUService: This DFU service that implementation Nordic's DFU library.  
    [![avatar](https://github.com/kkmhogen/KBeaconProDemo_Ios/raw/main/kbeacon_dfu__ios_arc.png?raw=true)](https://github.com/kkmhogen/KBeaconProDemo_Ios/blob/main/kbeacon_dfu__ios_arc.png?raw=true)
...
Also for more detail nordic DFU library, please refer to [https://github.com/NordicSemiconductor/IOS-Pods-DFU-Library](https://github.com/NordicSemiconductor/IOS-Pods-DFU-Library)
...
[Activity](/kkmhogen/KBeaconProDemo_Ios/activity)

### Stars

[**7** stars](/kkmhogen/KBeaconProDemo_Ios/stargazers)

### Watchers

[**2** watching](/kkmhogen/KBeaconProDemo_Ios/watchers)

### Forks

[**4** forks](/kkmhogen/KBeaconProDemo_Ios/forks)

[Report repository](/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fkkmhogen%2FKBeaconProDemo_Ios&report=kkmhogen+%28user%29)

## [Releases](/kkmhogen/KBeaconProDemo_Ios/releases)

No releases published

## [Packages 0](/users/kkmhogen/packages?repo_name=KBeaconProDemo_Ios)

No packages published  

## [Contributors 2](/kkmhogen/KBeaconProDemo_Ios/graphs/contributors)
...
*   [Swift 98.0%](/kkmhogen/KBeaconProDemo_Ios/search?l=swift)
*   [C 1.9%](/kkmhogen/KBeaconProDemo_Ios/search?l=c)
*   [Ruby 0.1%](/kkmhogen/KBeaconProDemo_Ios/search?l=ruby)